...
//var getarray = function (d, a) {

//    console.log("Sum =" + d);
//};
function getarray(sale,saleReturn)
{
    ...
    options = {
        ...
        xaxis: {
            categories: ["Feb","Mar","Apr","May","Jun","July","Aug","Sep","Oct","Nov","Dec","Jan"]
        },
...
function getpurchase(purchase,PurchaseReturn) {
    ...
    options = {
        ...
        series: [
            {
            name: "Purchase Net Total",
            data: purchase
        },
            {
                name: "Purchase Return Net Total",
                data: PurchaseReturn
            }
        ],
        colors: ["#F39C12", "#D7263D", "#f46d6a"],
        xaxis: {
            categories: ["Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan"]
        },
        yaxis: {
...
(chart = new ApexCharts(document.querySelector("#column_chartpurchase"), options)).render();
...
function getresturant(resturant) {
    ...
    options = {
        ...
        series: [{
            name: "Restaurant Net Total",
            data: resturant

        }
        ],
        colors: ["#5A2A27", "#D7263D", "#f46d6a"],
        xaxis: {
            categories: ["Feb", "Mar", "Apr", "May", "Jun", "July", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan"]
        },
        yaxis: {
        ...
        tooltip: {
            y: {
                formatter: function (e) {
                    return " " + e.toFixed(2) + " Rupees";
                }
            }
        }
    };

(chart = new ApexCharts(document.querySelector("#column_chartresturant"), options)).render();
